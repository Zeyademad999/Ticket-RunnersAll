...
const ProfileContent = () => {
  ...
  const userInfo = user
    ? {
        ...
        email: user.email,
        emergencyContact: "", // This would need to be fetched separately if needed
        emergencyContactName: "", // This would need to be fetched separately if needed
        bloodType: "", // This would need to be fetched separately if needed
        profileImage: user.profile_image_id
          ? `/uploads/${user.profile_image_id}`
