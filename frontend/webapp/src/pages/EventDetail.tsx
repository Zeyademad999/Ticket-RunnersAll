              ...
              <div className="card-elevated p-6 sticky top-24 flex flex-col gap-6">
                ...
                <div>
                  ...
                  <div
                    ...
                    className="group flex items-center gap-3 cursor-pointer p-4 bg-secondary/50 rounded-lg hover:bg-secondary/70 transition-all duration-300 border border-border/50 hover:border-primary/30"
                  >
